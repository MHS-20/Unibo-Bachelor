...
public class ServerCongressoImpl extends UnicastRemoteObject implements
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.out.println("Inserisci un tag da associare al servizio: ");
      String inTag = in.readLine();
      if(registryRemoto.associaTag(serviceName, inTag) == false)
      System.out.println("Il tag non e' presente");
