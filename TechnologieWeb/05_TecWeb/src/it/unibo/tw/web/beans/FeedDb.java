...
public class FeedDb implements Serializable {
	...
	public FeedDb() {
		...
		Feed feed = new Feed("Chiuse le urne, iniziano gli scrutini. In Sardegna sfida Soru-Cappellacci",
				...
				"", "POLITICA", "Mon, 16 Feb 2009 15:58:35 +0200",
		...
		feed = new Feed(
				...
				"", "ECONOMIA", "Mon, 16 Feb 2009 15:58:35 +0200",
				"http://www.lastampa.it/redazione/cmsSezioni/economia/200902articoli/41064girata.asp", "");
		this.feeds.add(feed);

		feed = new Feed("Del Noce:  \"Sanremo risorge o muore\"",
				...
				"", "SPETTACOLI", "Mon, 16 Feb 2009 15:58:35 +0200",
		...
		feed = new Feed("Alla sbarra i pirati del Web: \"Andr&agrave;  tutto bene\"",
				...
				"", "TECNOLOGIA", "Mon, 16 Feb 2009 15:58:35 +0200",
	...
	public List<String> getCategories(String categoryStartingWith) {
		return this.getFeeds().stream().filter(f -> f.getCategory().startsWith(categoryStartingWith))
				.map(ff -> ff.getCategory()).collect(Collectors.toList());
	}
}