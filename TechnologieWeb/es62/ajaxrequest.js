 ...
 */
function requestCalculation_callback( theXhr, callback ) {
 ...
 */
function requestCalculationIframe(theUri,theHolder) {
 ...
 */
function requestCalculationAJAX(theUri, theXhr, callback) {
    
	// impostazione controllo e stato della richiesta
	theXhr.onreadystatechange = function() { requestCalculation_callback(theXhr, callback); };
 ...
 */
function requestCalculation(uri,callback) {

	// assegnazione oggetto XMLHttpRequest
	var xhr = myGetXmlHttpRequest();

	if ( xhr ) 
         requestCalculationAJAX(uri,xhr, callback); 
	else 
        requestCalculationIframe(uri,callback); 
