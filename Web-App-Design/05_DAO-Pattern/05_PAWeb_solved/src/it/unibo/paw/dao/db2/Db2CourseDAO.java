...
public class Db2CourseDAO implements CourseDAO {
	...
	public void create(CourseDTO course) {
		...
		try {
			...
			/*
			//ON CASCADE
			//come per Student, anche in course si rendono persistenti le associazioni corso-studenti
			Db2StudentCourseMappingDAO csmdao = new Db2StudentCourseMappingDAO();
			for(StudentDTO s: course.getStudents())
				csmdao.create(course.getId(), s.getId());
			*/
